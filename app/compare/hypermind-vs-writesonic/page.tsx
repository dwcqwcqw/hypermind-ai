...
export const metadata: Metadata = {
  title: 'HyperMind vs Writesonic GEO | HyperMind',
  description: 'Writesonic GEO is associated with AI visibility monitoring and content workflows. HyperMind emphasizes citation supply chains, source development, and revenue attribution.',
  alternates: { canonical: '/compare/hypermind-vs-writesonic/' },
}
...
export default function Page() {
  return (
    <SeoLandingPage
      eyebrow="Comparison"
      title="HyperMind vs Writesonic GEO"
      description="Writesonic GEO is associated with AI visibility monitoring and content workflows. HyperMind emphasizes citation supply chains, source development, and revenue attribution."
      summary="Use HyperMind when the problem is not only creating content, but becoming the source AI systems trust and cite."
      bullets={[
