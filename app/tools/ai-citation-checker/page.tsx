...
export const metadata: Metadata = {
  title: 'AI Citation Checker | HyperMind',
  description: 'An AI citation checker finds which pages and domains are cited by AI systems when answering category, comparison, and product prompts.',
...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="An AI citation checker finds which pages and domains are cited by AI systems when answering category, comparison, and product prompts."
      summary="HyperMind uses citation checks to build a citation supply chain: owned pages, third-party reviews, media, community, partner, and institutional references."
      bullets={[
