            ...
            '@graph': [
              {
                ...
                url: 'https://hypermindgeo.com/resources/complete-geo-strategy-guide/',
                ...
                mainEntityOfPage: 'https://hypermindgeo.com/resources/complete-geo-strategy-guide/',
                inLanguage: 'en',
              },
              {
                '@type': 'BreadcrumbList',
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 3, name: 'Complete GEO Strategy Guide', item: 'https://hypermindgeo.com/resources/complete-geo-strategy-guide/' },
                ],
              },
              {
                '@type': 'FAQPage',
