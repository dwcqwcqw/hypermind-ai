            ...
            '@graph': [
              {
                ...
                url: 'https://hypermindgeo.com/resources/ai-visibility-monitoring-guide/',
                author: { '@type': 'Organization', name: 'HyperMind', url: 'https://hypermindgeo.com/' },
                publisher: { '@type': 'Organization', name: 'HyperMind', logo: { '@type': 'ImageObject', url: 'https://hypermindgeo.com/asset/logo.png' } },
                datePublished: '2025-03-15',
                dateModified: '2025-03-15',
                mainEntityOfPage: 'https://hypermindgeo.com/resources/ai-visibility-monitoring-guide/',
                inLanguage: 'en',
              },
              {
                '@type': 'BreadcrumbList',
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 3, name: 'AI Visibility Monitoring Guide', item: 'https://hypermindgeo.com/resources/ai-visibility-monitoring-guide/' },
                ],
              },
              {
                '@type': 'FAQPage',
