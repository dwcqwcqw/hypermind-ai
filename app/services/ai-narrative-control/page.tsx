...
export const metadata: Metadata = {
  title: 'AI Narrative Control | HyperMind',
  description: 'AI narrative control shapes the language AI systems use when explaining what a brand does, who it serves, and how it compares.',
  alternates: { canonical: '/services/ai-narrative-control/' },
}
...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="AI narrative control shapes the language AI systems use when explaining what a brand does, who it serves, and how it compares."
      summary="HyperMind identifies inaccurate or weak narratives, traces them to source material, and replaces them with clearer answer-ready claims across trusted pages."
      bullets={[
      ...
      related={[
        ...
        { label: 'Related GEO page', href: '/services/ai-answer-optimization' },
