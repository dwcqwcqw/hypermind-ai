...
export const metadata: Metadata = {
  title: 'AI Brand Sentiment Index | HyperMind',
  description: 'An AI brand sentiment index measures the tone and accuracy of AI-generated brand descriptions.',
  alternates: { canonical: '/data/ai-brand-sentiment-index/' },
}
...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="An AI brand sentiment index measures the tone and accuracy of AI-generated brand descriptions."
      summary="The index is most useful when paired with source analysis, because AI sentiment usually reflects the claims available in retrievable web content."
      bullets={[
