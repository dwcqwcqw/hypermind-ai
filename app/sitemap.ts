...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/resources/ai-answer-source-log/`, lastModified: '2026-06-25', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-visibility-content-gap-brief/`, lastModified: '2026-06-24', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-visibility-prompt-test-plan/`, lastModified: '2026-06-22', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-competitor-citation-audit/`, lastModified: '2026-06-17', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-source-repair-brief/`, lastModified: '2026-06-16', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-visibility-metrics-brief/`, lastModified: '2026-06-15', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-visibility-tool-selection-scorecard/`, lastModified: '2026-06-14', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-visibility-ownership-map/`, lastModified: '2026-06-13', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-shortlist-evidence-brief/`, lastModified: '2026-06-11', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-source-coverage-matrix/`, lastModified: '2026-06-11', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-visibility-platform-evaluation-playbook/`, lastModified: '2026-06-11', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/chatgpt-brand-mention-gap-audit/`, lastModified: '2026-06-09', changeFrequency: 'monthly', priority: 0.95 },
    { url: `${baseUrl}/resources/ai-citation-source-graph/`, lastModified: '2026-06-09', changeFrequency: 'monthly', priority: 0.95 },
