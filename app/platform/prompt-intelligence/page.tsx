...
export const metadata: Metadata = {
  title: 'Prompt Intelligence | HyperMind',
  description: 'Prompt intelligence is the process of discovering the questions buyers ask AI systems before they search, compare, or contact vendors.',
  alternates: { canonical: '/platform/prompt-intelligence/' },
}
...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="Prompt intelligence is the process of discovering the questions buyers ask AI systems before they search, compare, or contact vendors."
      summary="HyperMind groups prompts by buying intent, problem intent, competitor intent, risk validation, pricing research, and final recommendation moments."
      bullets={[
