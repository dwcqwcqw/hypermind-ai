...
export const metadata: Metadata = {
  title: 'AI Citation Source Analysis | HyperMind',
  description: 'AI citation source analysis maps which domains and source types models use when forming answers in a category.',
  alternates: { canonical: '/platform/ai-citation-source-analysis/' },
}
...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="AI citation source analysis maps which domains and source types models use when forming answers in a category."
      summary="HyperMind uses this analysis to decide whether a brand needs owned content, earned media, review coverage, partner pages, community references, or data assets."
      bullets={[
      ...
      related={[
        ...
        { label: 'Related GEO page', href: '/data/ai-citation-sources-database' },
